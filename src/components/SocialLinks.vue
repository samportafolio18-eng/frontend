...
const links = computed(() =>
  [
    ...
    },
    {
      key: 'email',
      label: 'Gmail',
      href: c.value.email ? `mailto:${c.value.email}` : '',
      color: '#EA4335',
    ...
    },
    {
      key: 'whatsapp',
      label: 'WhatsApp',
      href: c.value.whatsapp ? `https://wa.me/${c.value.whatsapp.replace(/\D/g, '')}` : '',
      color: '#25D366',
...
<template>
  <div class="social">
    <a
      ...
      :title="l.label"
      class="social__btn"
      :style="{ '--brand': l.color, width: `${size}px`, height: `${size}px` }"
      target="_blank"
      rel="noopener"
    >
